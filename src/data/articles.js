  ...
  zh: [
    {
      ...
      ctaTitle: "想進一步了解硬地滾球？",
      relatedLinks: [
        { label: "了解硬地滾球基本玩法", path: "/rules" },
        { label: "查看本會服務", path: "/services" },
        { label: "了解教練及裁判培訓", path: "/coaches-referees" },
        { label: "聯絡本會", path: "/contact" },
      ],
    },
  ],
  en: [
    {
      ...
      ctaTitle: "Would you like to learn more about Boccia?",
      relatedLinks: [
        { label: "Learn the basic rules of Boccia", path: "/rules" },
        { label: "Explore our services", path: "/services" },
        { label: "Learn about coach and referee development", path: "/coaches-referees" },
        { label: "Contact the Association", path: "/contact" },
      ],
    },
  ],
};
